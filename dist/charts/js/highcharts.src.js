...
(function ($) {
	 ...
	 */
	win.dy_HighchartsAdapter = win.dy_HighchartsAdapter || ($ && {
...
var globalAdapter = win.dy_HighchartsAdapter,
...
Chart.prototype = {
	...
	firstRender: function () {
		...
		if (dy_Highcharts.RangeSelector && options.rangeSelector.enabled) {
			chart.rangeSelector = new dy_Highcharts.RangeSelector(chart);
		}
		...
		if (dy_Highcharts.Scroller && (options.navigator.enabled || options.scrollbar.enabled)) {
			chart.scroller = new dy_Highcharts.Scroller(chart);
		}
